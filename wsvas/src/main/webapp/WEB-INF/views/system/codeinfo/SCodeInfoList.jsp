        ...
        <div class="searchBar">
            <table class="searchContent">
                ...
                <tr>
                    <td>
                        <label>代码名称：</label>
                        <input id="codeName" type="text" name="codeName">
                    </td>
                    <td>
                        <label>排序号：</label>
                ...
                <tr>
                    <td colspan="4" align="center">
                        <button type="button" class="btn btn-small" style="margin-bottom: 3px;"
...
<jsp:include page="EditSCodeInfo.jsp"/>
</body>
</html>
    ...
    function queryAction() {
        $(".grid").flexReload({
            ...
            params : [
                ...
                {'name':'codeValue', 'value':$("#codeValue").val()},
                {'name':'codeName', 'value':$("#codeName").val()},
