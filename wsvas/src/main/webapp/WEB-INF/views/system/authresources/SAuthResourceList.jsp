...
<jsp:include page="EditSAuthResource.jsp"/>
</body>
</html>
<script type="text/javascript">
    $(function () {
        ...
        (
            {
                url:'<c:url value="/system/sAuthResource/load" />',
                dataType: 'json',
                method: 'POST',
                colModel:[
    ...
    function editAction(rowId) {
        ...
        editFrom.form("load", "<c:url value='/system/sAuthResource/'/>" + id);
    }
    ...
    function deleteAction() {
        ...
        $.messager.confirm("确认框", "是否确认删除选中的记录？", function(flag) {
            if(flag) {
                ...
                $.post("<c:url value='/system/sAuthResource/delete'/>", {
                    'ids' : values
                }, function(data) {
                    if(data.code == "0") {
